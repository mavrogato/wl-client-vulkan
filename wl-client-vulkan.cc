...
int main() {
    ...
    try {
        ...
        */
        ...
        auto mem_requirements = device->getBufferMemoryRequirements(buffer_per_frames.front());
        ...
        device->bindBufferMemory(buffer_per_frames[0], mem_entire_frames.get(), 0);
        device->bindBufferMemory(buffer_per_frames[1], mem_entire_frames.get(), mem_requirements.size);
